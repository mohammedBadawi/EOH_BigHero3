...
import com.example.root.eoh.MainActivity;
...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtType = (EditText) findViewById(R.id.txt_user_user_type_register);
    ...
    public void AddUser(){
        ...
        databaseReference.child(UID).child("rat").setValue("default");
        databaseReference.child(UID).child("skills").setValue("default");
        databaseReference.child(UID).child("bounuce").setValue("default");
        databaseReference.child(UID).child("tasks").setValue("default");
        databaseReference.child(UID).child("user_type").setValue(txtType.getText().toString());
